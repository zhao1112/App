package com.zhao.testmvvm.widget;
...
public class NormalItemView extends BaseTabItem {
    ...
    public NormalItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIcon = findViewById(me.majiajie.pagerbottomtabstrip.R.id.icon);
        mTitle = findViewById(me.majiajie.pagerbottomtabstrip.R.id.title);
        mMessages = findViewById(me.majiajie.pagerbottomtabstrip.R.id.messages);
    }
